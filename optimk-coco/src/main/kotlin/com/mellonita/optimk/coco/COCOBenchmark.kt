...
class BBOBBenchmark(
    ...
    suiteOptions: String = "",
    maxEvaluations: Long
) : COCOBenchmark(algorithmName, algorithmInfo, "bbob", suiteOptions, maxEvaluations) {
    ...
    override val nextProblem: SingleObjectiveCOCOProblem?
        get() {
            ...
            return ContinuousProblem(cocoProblem, maxEvalMultiplier)
        }
...
class BBOBBMixIntBenchmark(
    ...
    suiteOptions: String = "",
    maxEvaluations: Long
) : COCOBenchmark(algorithmName, algorithmInfo, "bbob-mixint", suiteOptions, maxEvaluations) {
    ...
    override val nextProblem: SingleObjectiveCOCOProblem?
        get() {
            ...
            return MixIntProblem(cocoProblem, maxEvalMultiplier)
        }
